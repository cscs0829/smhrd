...
- **여행 키워드 중복 방지**: "여행"으로 끝나는 키워드는 제목에 하나만 포함 (예: 가족여행, 미식여행, 온천여행, 패키지여행등 중 하나만 선택)
- 영어 사용 금지
...
- **여행 키워드 중복 방지**: "여행"으로 끝나는 키워드는 하나만 포함 (가족여행, 미식여행, 온천여행, 패키지여행 중 하나만 선택)
- 한국어로만 작성
- 쉼표로 구분하여 나열
- 검색 의도에 맞는 실용적인 키워드
- 기호 사용 금지 (실질 형태소만 사용)
- 브랜드 가치를 훼손하는 단어 사용 금지
- 예시: "홋카이도여행", "일본3박4일", "삿포로골프", "겨울눈꽃축제", "패키지여행" (여행 키워드는 하나만)
