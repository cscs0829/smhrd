...
1. 지역명: ${location}
2. 국가명: 일본, 중국, 유럽 등
3. 여행기간: 2박3일, 3박4일, 4박5일 등
4. 계절/월: 10월, 12월, 겨울, 여름 등
5. 도시명: 삿포로, 도쿄, 오사카 등
6. 여행유형: 패키지여행, 자유여행, 골프여행 등
7. 특별활동: 노쇼핑투어, 온천, 크루즈, 눈꽃축제 등
8. 브랜드: 하나투어 (선택적)
9. 추가키워드: 해외여행, 가족여행 등
10. 카테고리 키워드: ${category.seoKeywords.join(' ')}
...
- 예시: "홋카이도 일본 3박4일 홋카이도 10월 추석연휴 삿포로 하나투어 노쇼핑투어 북해도 골프여행"
