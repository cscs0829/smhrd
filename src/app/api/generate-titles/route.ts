...
async function generateTravelTitles(
  ...
  const naverSeoKeywords = [
    ...
    // 브랜드/업체 키워드
    '하나투어', '모두투어', '여행박사', '트리플원투어', '트래블로버', '투어맨',
    // 추가 키워드
...
5. **브랜드 키워드 적절히 포함**: 신뢰성과 구분을 위한 업체명
...
- 필수 포함 요소: 지역명, 국가명, 여행기간, 계절/월, 도시명, 여행유형, 특별활동, 브랜드(선택)
...
- 실제 네이버 가격비교 상위 노출 제목 스타일: "홋카이도 일본 3박4일 홋카이도 10월 추석연휴 삿포로 하나투어 노쇼핑투어 북해도 골프여행"
- 새로운 지역(예: 스페인)의 경우 해당 지역의 대표 도시, 문화, 음식, 축제, 관광지를 포함한 키워드 활용
- 영어 사용 금지
...
- 예시: "홋카이도여행", "일본3박4일", "삿포로골프여행", "겨울눈꽃축제", "하나투어패키지"
- 스페인 예시: "스페인여행", "바르셀로나3박4일", "마드리드플라멩고", "세비야축제", "스페인골프여행"
